...
model: sonnet
skills: mcp-builder, fastapi-expert, nestjs-expert, api-designer, postgres-pro, python-pro, graphql-architect, microservices-architect, secure-code-guardian, test-master
---
